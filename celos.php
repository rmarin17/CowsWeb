...
<html>
  ...
  <body>
    <main>
      <h1 class="grey-text text-darken-2" align="center" style="font-size:50px;font-family:Constantia;">Celos del Ganado</h1>
        <div  class="container">
          <div  class="section">
            <!-- Comienza los tabs -->
            <div class="panel">
                <div class="row " id="tabs">	
                    <div class="col s12 ">
                        <ul class="tabs ">
                            <li class="tab col s4"><a href="#addcow">Registrar Celos</a></li>
                            <li class="tab col s4"><a href="#upcsvp">Subir Csv Excel</a></li>
                            <li class="tab col s4 "><a href="#cowlist">Celos Registrados</a></li>
                        </ul>
                    </div>
                    <br></br>
                    <br></br>
                    <div id="addcow" class="col s12">
                        <center><p class="flow-text">Primero selecciona la vaca del servicio y posteriormente la fecha.</p></center>
                        <br></br>
                        <section id="form">                            
                    ...
                    <div id="cowlist" class="col s12">
                            ...
                            while ($fila = mysqli_fetch_assoc($res)){ ?>
                                <tbody>   
                                    <tr> 
                                        ...
                                        <td><a href="modcelos.php?idc=<?php echo $fila['idc'];?>&idu=<?php echo $fila['idu'];?>"><i Style="color:#546e7a;" class="material-icons">edit</i></a></td>                                        
                                    </tr>
                                <tbody>  
                                <?php $datos='si';
                                    }
                        ...
                        <div id="modal2" class="modal">
                            ...
                            <div class="modal-footer">
                            <a class="modal-action modal-close waves-effect waves-green btn-flat">No</a>
                            <input href="includes/delevarcelos.php?tabla=celos" type="submit" name="borrar" class="modal-action modal-close waves-effect waves-green btn-flat" value="Si"></input>
                            </div>
                        </div>
                        </form>
                    </section></div>
