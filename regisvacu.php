...
<html>
    ...
    <body>
        <main>
            <center><h1 class="flow-text" style="color:teal;font-size:50px;font-family:calibri;">Registrar Vacuna</h1></center>            
            <br></br>
            <section id="form" style="margin-left:300px; margin-right:300px">
                <form class="col s12"action="includes/regisvacu.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input name="vacuna" type="date" class="datepicker validate" required="" aria-required="true">
                    ...
                    <div id="c" class="col s6">
                        ...
                        <div class="input-field " class="validate" required="" aria-required="true">
                            ...
                            <option value="Brucelas">Bruselas</option>
                            <option value="Estomatitis">Estomatitis</option>
                            </select>
