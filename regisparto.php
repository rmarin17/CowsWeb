    ...
    <body>
        <main>
            ...
            <section id="form" style="margin-left:300px; margin-right:300px">
                <form class="col s12"action="includes/regisparto.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input name="parto" type="date" class="datepicker validate" required="" aria-required="true">
