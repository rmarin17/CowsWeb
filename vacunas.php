...
<html>
  ...
  <body>
    <main>
      <h1 class="grey-text text-darken-2" align="center" style="font-size:50px;font-family:Constantia;">Vacunación del Ganado</h1>
        <div  class="container">
          <div  class="section">
            <!-- Comienza los tabs -->
            <div class="panel">
                <div class="row " id="tabs">	
                    <div class="col s12 ">
                        <ul class="tabs ">
                            <li class="tab col s4"><a href="#addcow">Registrar Vacunas</a></li>
                            <li class="tab col s4"><a href="#upcsvp">Subir Csv Excel</a></li>
                            <li class="tab col s4 "><a href="#cowlist">Vacunas Registrados</a></li>
                        </ul>
                    </div>
                    <br></br>
                    <br></br>
                    <div id="addcow" class="col s12">
                        <center><p class="flow-text">Primero selecciona la vaca y posteriormente la demas información.</p></center>
                        <br></br>
                        <section id="form">                            
                            ...
                            while ($fila = mysqli_fetch_assoc($res)){ ?>
                                <tbody>   
                                    <tr>                                
                                        ...
                                        <td><a href="regisvacu.php?id=<?php echo $fila['idg'];?>&idu=<?php echo $fila['idu'];?>"><i Style="color:#546e7a;" class="material-icons">add_circle</i></a></td>                                        
                                    </tr>
                                <tbody>  
                                <?php $datos='si';
                                    }
                    ...
                    <div id="cowlist" class="col s12">
                        <form method="post" action="includes/delvarcelos.php">
                            ...
                            <?php
                            include 'includes/conexion.php';
                            $sql = "SELECT * FROM ganado INNER JOIN vacunas ON ganado.idg = vacunas.idg ORDER BY nombre";//consulta inter tablas
                            $res =mysqli_query($conn,$sql);                            
                            //$datos='';
                            if(mysqli_num_rows($res) == 0){ ?>
                                <center><h style="color:teal;font-size:50px;font-family:calibri;">No Existen Datos Registrados</h></center>
                        ...
                        <div id="modal1" class="modal">
                            ...
                            <p>Recuerde que se borraran todos los datos de vacunación registrados y una vez completada la acción no se podrán volver a recuperar, ¿está seguro de eliminar todos los datos?</p>
                            </div>
                            <div class="modal-footer">
                            <a class="modal-action modal-close waves-effect waves-green btn-flat">No</a>
                            <a href="includes/deleteall.php?tabla=vacunas&idu=<?php echo $idu?>" class="modal-action modal-close waves-effect waves-green btn-flat">Si</a>
                            </div>
                        </div>
